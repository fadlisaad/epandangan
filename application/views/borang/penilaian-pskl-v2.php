                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="45%" class="text-center text-uppercase align-middle">
                                <p><strong>RINGKASAN PANDANGAN/CADANGAN AWAM</strong></p>
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-top" style="max-width: 200px;">
                                <?php if($dataUlasan['ulasan']): ?>
                                <p><strong><?php echo ($dataUlasan['kriteria'] != "Lain-Lain") ? "Berkaitan ".$dataUlasan['kriteria'] : $dataUlasan['kriteria'] ?></strong></p>
                        ...
                        <tr>
                            ...
                            <td class="align-top" style="max-width: 200px;">
                                <?php if($dataUlasanMatlamat['ulasan']): ?>
                                    <p><strong><?php echo ($dataUlasanMatlamat['kriteria'] != "Lain-Lain") ? "Berkaitan ".$dataUlasanMatlamat['kriteria'] : $dataUlasanMatlamat['kriteria'] ?></strong></p>
                                ...
                                <?php endif; ?>
                                <?php if($dataUlasanMatlamat['matlamat'] != NULL): ?>
                                <table>
                                    <tr>
                                        <td colspan="2">RUJUKAN DALAM DRAF PSKL 2040</td>
                                    </tr>
