                            ...
                            <form method="post" id="borang-ptkl" data-parsley-validate="" enctype="multipart/form-data" action="<?php echo BASE_URL ?>borang/add_ptkl/ptkl">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-9">
                                        ...
                                        <input type="text" class="form-control" name="nama_penuh" id="nama_penuh" value="<?php echo @$profile[0]['nama_penuh'] ?>" required="" data-parsley-type="alphanum">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="pandangan_awam" class="form-control" name="pandangan_awam" rows="10" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-validation-threshold="5" placeholder="Contoh: Selaraskan Syarat Nyata"></textarea>
                                </div>
