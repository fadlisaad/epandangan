            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h2 class="borang_title">APPENDIX</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="title-box">
                            <h4 style="padding-left:10px;">BAHAGIAN A : BUTIRAN PEMBERI PANDANGAN</h4>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="title-box">
                            <h4 style="padding-left:10px;">BAHAGIAN B : BUTIRAN PANDANGAN TERHADAP DRAF PELAN STRUKTUR KUALA LUMPUR 2040 (DRAF PSKL2040)</h4>
                        </div>
