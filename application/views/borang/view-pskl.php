            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box ribbon-box" style="font-size: 1rem !important;">
                            ...
                            <div class="ribbon-content">
                                ...
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-9"><?php echo empty($ulasan[0]['last_update']) ? "Tiada" : $dateHelper->convertTimestamp($ulasan[0]['last_update']) ?></dd>
                        ...
                        <div class="card-box ribbon-box" style="font-size: 1rem !important;">
                            <h4 class="header-title">Ulasan Keseluruhan Jabatan Perancangan Bandaraya</h4>
                            <div class="ribbon-content">
                                ...
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-9">
                                        ...
                                        <input type="hidden" name="borang_id" value="<?php echo $data[0]['borang_id'] ?>">
                                        <input type="hidden" name="user_id" value="<?php echo @$ulasanOverall[0]['user_id'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <h5 class="card-header">LAPORAN PENILAIAN</h5>
                                    <div class="card-body">
                                        <?php if($penilaian):
                                        echo "<h4>Kriteria Penilaian</h4><ul>";
                                        foreach ($penilaian as $nilai) {
                                            echo "<li><a href=\"".BASE_URL."borang/penilaian/".$nilai['id']."\">".$nilai['kriteria']."</a></li>";
                                        }
                                        echo "</ul>";
                                        else: ?>
                                        <p>Belum ada laporan penilaian</p>
                                        <?php endif; ?>
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#laporan-penilaian">Tambah</button>
                                    </div>
                                </div>
        ...
        <!-- Start modal laporan penilaian -->
        <div id="laporan-penilaian" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Tambah Laporan Penilaian</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                    </div>
                    <div class="modal-body p-4">
                        <form id="penilaian" method="post">
                            <div class="form-group row">
                                <label for="kriteria" class="control-label col-md-4">Kriteria</label>
                                <select class="col-md-8" name="kriteria" id="kriteria">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Tutup</button>
                        <button type="button" class="btn btn-info waves-effect waves-light" data-dismiss="modal" id="save-penilaian">Tambah</button>
                    </div>
                </div>
            </div>
        </div><!-- /.modal -->