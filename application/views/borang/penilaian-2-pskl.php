                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="1%">:</td>
                            <td width="27%">
                                <?php if($dataPA3[0]['nama_1_text']): ?>
                                    <?php echo @$dataPA3[0]['nama_1_text'] ?>
                                <?php else: ?>
                            ...
                            <td width="1%">:</td>
                            <td width="27%">
                                <?php if($dataPA3[0]['nama_2_text']): ?>
                                    <?php echo @$dataPA3[0]['nama_2_text'] ?>
                                <?php else: ?>
                            ...
                            <td width="1%">:</td>
                            <td width="27%">
                                <?php if($dataPA3[0]['nama_3_text']): ?>
                                    <?php echo @$dataPA3[0]['nama_3_text'] ?>
                                <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?php if($dataPA3[0]['jawatan_1']): ?>
                                    <?php echo @$dataPA3[0]['jawatan_1_text'] ?>
                                <?php else: ?>
                            ...
                            <td>:</td>
                            <td>
                                <?php if($dataPA3[0]['jawatan_2']): ?>
                                    <?php echo @$dataPA3[0]['jawatan_2_text'] ?>
                                <?php else: ?>
                            ...
                            <td>:</td>
                            <td>
                                <?php if($dataPA3[0]['jawatan_3']): ?>
                                    <?php echo @$dataPA3[0]['jawatan_3_text'] ?>
                                <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?php if($dataPA3[0]['tarikh_1']): ?>
                                    <?php echo @$dateHelper->convertDate($dataPA3[0]['tarikh_1']) ?>
                                <?php else: ?>
                                <input type="date" name="tarikh_1" value="<?php echo @$dataPA3[0]['tarikh_1'] ?>">
                                <?php endif; ?>
                            </td>
                            <td class="font-weight-bold">Tarikh</td>
                            <td>:</td>
                            <td>
                                <?php if($dataPA3[0]['tarikh_2']): ?>
                                    <?php echo @$dateHelper->convertDate($dataPA3[0]['tarikh_2']) ?>
                                <?php else: ?>
                                <input type="date" name="tarikh_2" value="<?php echo @$dataPA3[0]['tarikh_2'] ?>">
                                <?php endif; ?>
                            </td>
                            <td class="font-weight-bold">Tarikh</td>
                            <td>:</td>
                            <td>
                                <?php if($dataPA3[0]['tarikh_3']): ?>
                                    <?php echo @$dateHelper->convertDate($dataPA3[0]['tarikh_3']) ?>
                                <?php else: ?>
                                <input type="date" name="tarikh_3" value="<?php echo @$dataPA3[0]['tarikh_3'] ?>">
                                <?php endif; ?>
                            </td>
                        </tr>
