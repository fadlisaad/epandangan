                        ...
                        <div class="col-md-3">
                            <div class="card-box bg-pattern">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <h3 class="text-dark my-1"><span data-plugin="counterup"><?php echo $countHadir; ?></span></h3>
                                            <p class="text-muted mb-0 text-truncate">Hadir</p>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end card-box-->
                        ...
                        <div class="col-md-3">
                            <div class="card-box bg-pattern">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <h3 class="text-dark my-1"><span data-plugin="counterup"><?php echo $countTidakHadir; ?></span></h3>
                                            <p class="text-muted mb-0 text-truncate">Tidak Hadir</p>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end card-box-->
